...
public:
    ...
    using StateChangedSignal = boost::signals2::signal<void(Unit::State)>;
    using DamageChangedSignal = boost::signals2::signal<void(int16_t)>;
    using HealthChangedSignal = boost::signals2::signal<void(int16_t)>;
    using MaxHealthChangedSignal = boost::signals2::signal<void(int16_t)>;
    using ArmorChangedSignal = boost::signals2::signal<void(int16_t)>;
    using ResistanceChangedSignal = boost::signals2::signal<void(int16_t)>;
...
public:
    ...
    boost::signals2::scoped_connection OnStateChangedConnector(const StateChangedSignal::slot_type& slot);
    ...
    boost::signals2::scoped_connection OnDamageChangedConnector(const DamageChangedSignal::slot_type& slot);

    int16_t GetHealth() const
    { return _health; }

    boost::signals2::scoped_connection OnHealthChangedConnector(const HealthChangedSignal::slot_type& slot);

    int16_t GetMaxHealth() const
    { return _healthLimit; }

    boost::signals2::scoped_connection OnMaxHealthChangedConnector(const MaxHealthChangedSignal::slot_type& slot);

    int16_t GetArmor() const
    { return _armor; }

    boost::signals2::scoped_connection OnArmorChangedConnector(const ArmorChangedSignal::slot_type& slot);

    int16_t GetResistance() const
    { return _resistance; }

    boost::signals2::scoped_connection OnResistanceChangedConnector(const ResistanceChangedSignal::slot_type& slot);
